...
class TestBaseWebAPI(TestCase):
    def setUp(self):
        ...
        self.conn_refused_obj = BaseWebAPI(
            "localhost", "nouser", "nopass", alt_port="9999"
        )
        self.good_secure_obj = BaseWebAPI("localhost", "nouser", "nopass", secure=True)
        self.good_sec_alt_obj = BaseWebAPI(
    ...
    def test_incorrect_arguments(self):
        ...
        self.assertRaises(
            ValueError, BaseWebAPI, "localhost", "nouser", "nopass", secure="Yes"
        )
        self.assertRaises(
            ValueError,
            BaseWebAPI,
    ...
    def test_bad_kwarg(self):
        ...
        self.assertRaises(
            TypeError, self.good_obj._transaction, "get", "/", mykey="test"
        )
    ...
    def test_refused_connection(self):
        ...
        self.assertRaises(
            requests.exceptions.ConnectionError,
            self.conn_refused_obj._transaction,
            "get",
            "/",
        )
    ...
    def test_status_code(self, mock_req):
        self.assertRaises(
            requests.exceptions.HTTPError, self.bad_status_obj._transaction, "post", "/"
        )
